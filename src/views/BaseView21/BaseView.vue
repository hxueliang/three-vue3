...
onMounted(() => {
  ...
  threePlus.setBgJpg("./hdr/bl.jpg");

  // 加载模型
  threePlus.gltfLoader("./model/room/exhibition-min1.glb").then((gltf) => {
    let floorArr = [];
  ...
  let texture = new THREE.TextureLoader().load("./texture/effect/jj.png");
...
.loading {
  ...
  width: 100vw;
  height: 100vh;
  background-image: url(../../assets/imgs/room/loading.jpg);
