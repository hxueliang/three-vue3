...
function createCode() {
  ...
  scene.add(model);
  gltfLoader.load('./model/other/airplane/scene.gltf', function (gltf) {
    ...
    model.add(new THREE.ArrowHelper(a, O, 3, 0xff0000));
    model.add(new THREE.ArrowHelper(b, O, 3, 0x00ff00));
